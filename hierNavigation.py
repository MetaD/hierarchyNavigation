...
if __name__ == '__main__':
    ...
    if END_QUESTIONS:
        ...
        shapes = [visual.Rect(presenter.window, width=0.2, height=1, pos=(-0.5, 0.3), lineWidth=0, fillColor=grey),
                  ...
                  visual.Rect(presenter.window, width=0.59, height=0.3, pos=(-0.35, -0.4), lineWidth=0, fillColor=grey),
                  visual.Rect(presenter.window, width=0.2, height=1, pos=(0.5, -0.3), lineWidth=0, fillColor=grey),
        ...
        two_step_anchor_pos = [(-0.5, 0.65), (0.55, 0.4), (-0.55, -0.4), (0.5, -0.65)]  # down, left, right, up
        #  b) 3 steps
